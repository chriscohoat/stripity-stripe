defmodule Stripe.Invoice do
  ...
  (
    defstruct [
      ...
      :customer_tax_exempt,
      # ---- NEW (2024-25) FIELDS ----
      # cents the customer paid > amount_due
      :amount_overpaid,
      # timestamp when invoice will auto-finalize
      :automatically_finalizes_at,
      # map; usually %{type: "self"} for self-issued
      :issuer,
      # map with subscription/quote linkage
      :parent,
      # array of pretax credit breakdowns
      :total_pretax_credit_amounts,
      # array of tax breakdowns (≠ total_tax_amounts)
      :total_taxes
    ]
    ...
    @type t :: %__MODULE__{
            ...
            issuer: term | nil,
            parent: term | nil,
            total_pretax_credit_amounts: term,
            total_taxes: term
          }
  )
