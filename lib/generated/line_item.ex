defmodule Stripe.LineItem do
  ...
  (
    defstruct [
      ...
      # -- NEW Stripe fields (2024-04 dashboard + later API versions)
      # map describing what generated the line-item
      :parent,
      # map with price-details & unit_amount_decimal
      :pricing,
      # array of tax objects (≠ tax_amounts)
      :taxes
    ]
